...
int main()
{
    ...
    scanf("%c", &ch);
    ch = '7';
    (isalnum(ch)) ? printf("%c is alphanumeric.\n", ch) : printf("%c is not alphanumeric.\n", ch);

    ch = '9';
    (isdigit(ch)) ? printf("%c is a digit.\n", ch) : printf("%c is not a digit.\n", ch);

    ch = 'a';
    (islower(ch)) ? printf("%c is lowercase.\n", ch) : printf("%c is not lowercase.\n", ch);

    ch = 'Z';
    (isupper(ch)) ? printf("%c is uppercase.\n", ch) : printf("%c is not uppercase.\n", ch);
